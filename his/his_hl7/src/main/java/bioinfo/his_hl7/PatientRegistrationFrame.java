...
public class PatientRegistrationFrame extends JFrame {
	...
	public PatientRegistrationFrame() {
		...
		comboBox_3 = new JComboBox<Character>(new DefaultComboBoxModel<Character>(new Character[] {'F', 'M', 'O', 'U'}));
		
		JLabel lblEstadoCivil = new JLabel("Estado Civil:");
		
		comboBox_4 = new JComboBox<MaritalStatus>(new DefaultComboBoxModel<MaritalStatus>(bioinfo.his_hl7.MaritalStatus.values()));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addComponent(datePicker, GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)))
					.addContainerGap())
		);
